    ...
    <>
      ...
      {showModal && (
        <div id="quiz-modal" className="relative z-50">
          <div className="fixed inset-0 bg-slate-900 bg-opacity-95 flex items-center justify-center">
            {!formSubmitted && (
              <div className="bg-white p-12 max-w-xl my-4 text-black h-[99%] rounded-sm-sm overflow-y-auto">
                <p className="text-base text-center font-bold leading-7 text-accent-700 uppercase">
                  QUIZ
                </p>
                ...
                <form onSubmit={handleSubmit} className="mt-8 font-light">
                  <div className="mb-4">
                    <label
                      htmlFor="firstName"
                      className="mb-1 text-primary-950 font-semibold"
                    >
                      First Name
                      <input
                        type="text"
                  ...
                  <div className="mb-8">
                    <fieldset>
                      <legend className="mb-2 text-primary-950 font-semibold">
                  ...
                  <div className="mb-8">
                    <fieldset>
                      <legend className="mb-1 text-primary-950 font-semibold">
                  ...
                  <div className="mb-4">
                    <fieldset>
                      <legend className="mb-1 text-primary-950 font-semibold">
                        Would you be interested in scheduling a visit to Elite
                        Flight Training?
                      </legend>
